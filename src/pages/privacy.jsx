        ...
        <div className='relative -mt-[5.75rem] overflow-hidden pt-[5.75rem]'>
            <div className="px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative mx-auto max-w-[37.5rem] pt-20 text-center pb-16">
                    <div class="flex">
                        <div class="text-indigo-600 font-extrabold pr-5 pt-2">
                        <Link href="/#">
                        ...
                        <h1 className="text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">
                            UpSide Privacy Policy
                        </h1>
                    </div>
                    <p className="mt-4 text-base leading-7 text-slate-600">Updated February 21st, 2023.</p>
                </div>
            </div>
            ...
            <div className="relative px-4 sm:px-6 lg:px-8">
                <div className=" mx-auto max-w-[40rem] text-slate-600">
                    <p className='text-slate-600 text-sm'>
                        This privacy policy (&quot;Policy&quot;) describes how UpSide Digital INC (&quot;UpSide&quot;, &quot;we&quot;, &quot;us&quot; or &quot;our&quot;) collects, protects and uses the personally identifiable information (&quot;Personal Information&quot;) you (&quot;User&quot;, &quot;you&quot; or &quot;your&quot;) may provide through the UpSide website (<a className='text-indigo-700' href="https://upsideapp.io">upsideapp.io</a>) or in the course of purchasing any UpSide products (collectively, &quot;Website&quot;). The Policy also describes the choices available to you regarding our use of your Personal Information and how you can access and update this information. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.
                    </p>
                    <h2 className='text-xl text-black font-extrabold pt-5 pb-2'>
                        Collection of personal information

                    </h2>
                    <p className='text-slate-600 text-sm'>
                        We receive and store any information you knowingly provide to us when you make a purchase through the Website. Currently this is limited to your email address, which is required for you to be able to login to the Website and access any purchased UpSide products.
                    ...
                    <p className='text-slate-600 text-sm'>
                        All purchases made through the Website are processed by a third party payment processor, Paddle (<a className="text-indigo-700" href="https://paddle.com">paddle.com</a>). Paddle may ask you for personal and/or non-personal information, such as your name, address, email address, credit card information, or other Personal Information. Paddle has a privacy policy (<a className="text-indigo-700" href="https://paddle.com/legal-buyers">paddle.com/legal-buyers/</a>) that describes their collection and use of personal information. UpSide does not control Paddle or its collection or use of information. Any questions or concerns about Paddle’s practices should be directed to Paddle.
                    </p>
                    <p className='py-2 text-slate-600 text-sm'>
                    ...
                    <p className='text-slate-600 text-sm'>
                        Any requests to exercise User rights can be directed to the Owner by email at <a href="mailto:team@upsideapp.io" className='text-indigo-700'>team@upsideapp.io </a>. These requests can be exercised free of charge and will be addressed by the Owner as early as possible and always within one month.
                    ...
                    <p className='text-slate-600 text-sm'>
                        We offer electronic communications via email which users receive by default to the email provided during signup. You may choose to stop receiving our newsletter or marketing emails by following the unsubscribe instructions included in these emails or by contacting us. However, you will continue to receive essential transactional emails.
                    </p>
                    <h2 className='text-xl text-black font-extrabold pt-5 pb-2'>
                        Cookies
                    </h2>
                    ...
                    <p className='text-slate-600 text-sm'>
                        If you have any questions about this Policy, please contact us by email at <a href="mailto:team@upsideapp.io" className='text-indigo-700 text-sm'> team@upsideapp.io </a>.
